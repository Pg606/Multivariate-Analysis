...
plot(as.dendrogram(clusl_d.nn),ylab="Distance between Company Roles",ylim=c(0,2.5),main="Dendrogram of six company")

plot(as.dendrogram(clusl_d.nn),ylab="Distance between Company Roles",ylim=c(0,6),
     main="Dendrogram. Company roles")

plot(as.dendrogram(clusl_d.nn), xlab= "Distance between CVompany Layoffs", xlim=c(6,0),
     horiz = TRUE,main="Dendrogram. Company roles")
```
...
#Dendogram
plot(as.dendrogram(agn.l_d), xlab= "Distance between Roles",xlim=c(8,0),
     horiz = TRUE,main="Dendrogram of company roles")
```
